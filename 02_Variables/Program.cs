...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine();
            //Console.WriteLine("---------------");
            //Console.WriteLine("Yolcu TC Kimlik No: " + passengerIdentitNumber + " - Yolcu Ad Soyad: "+ passengerName + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity + " " + passengerAge);
